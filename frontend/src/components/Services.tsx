...
export const Services: React.FC<ServicesProps> = ({ onNavigate }) => {
  const services: Service[] = [
    {
      ...
      description: "Expert guidance on etiquette, timelines, and logistics from our AI concierge.",
      image: "/plan.jpg",
      iconImage: "/icon.png",
    ...
    },
    {
      ...
      image: "/6726043c22bf3ac45684472580ef5427.jpg",
      iconImage: "/icon.png",
    ...
    },
    {
      ...
      view: "vows",
      title: "Vow Atelier",
      description: "Craft articulate, heartfelt vows that capture your unique love story.",
      image: "/vow.jpg",
      iconImage: "/icon.png",
  ...
  const handleServiceClick = (service: Service) => {
    const target =
      service.id === "vision" ? service.sectionId || "inspiration" : service.id === "vows" ? "vows" : "services";

    if (onNavigate) {
      if (service.id === "vision") {
        onNavigate(service.view, service.sectionId || "inspiration");
      } else {
    ...
    <section id="services" className="bg-white py-16 md:py-20">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-14">
          <h2 className="font-serif text-[34px] md:text-[40px] text-[#2d241d] mb-4">Our Curated Services</h2>
            ...
            >
              ...
              <div className="px-8 py-8 text-center">
                <div className="w-10 h-10 mx-auto mb-5 rounded-full border border-[#e6e1dc] flex items-center justify-center overflow-hidden">
                  <img src={service.iconImage} alt={service.iconAlt} className="w-full h-full object-cover" loading="lazy" />
                </div>

                <h3 className="font-serif text-xl text-[#2d241d] mb-3">{service.title}</h3>
                <p className="text-[13px] leading-6 text-[#7a7068] mb-6">{service.description}</p>
